...
+
    ...
    txa
    asl a
    sta.l af_i2                 ; 2*i pour les tableaux 16 bits
    tay
...
+
    ...
    sec
    sbc.l af_cx
    sta.l af_sx                 ; 16 bits : le 9e bit sert plus bas
    and.w #$00FF
    sta.l af_x8
...
_prio_ok:
    ...
    lda.l af_i2                 ; LDY n'a pas de mode long : passer par A
    tay
...
_suivant:
    inx
    cpx.w af_n                  ; CPX n'a pas de mode long ; af_n est en
...
; Variables de travail — hors du .bss de tcc pour ne pas dependre de son
; allocateur, et en bank $7E comme le reste des donnees chaudes.
.RAMSECTION "actorsfastvars" BANK $7E SLOT 2 FORCE
af_n      dw
af_cx     dw
af_cy     dw
af_cxmax  dw
